...
function s(t, r) {
  ...
  if (!(typeof document > "u")) {
    ...
    e.type = "text/css", o === "top" && a.firstChild ? a.insertBefore(e, a.firstChild) : a.appendChild(e), e.styleSheet ? e.styleSheet.cssText = t : e.appendChild(document.createTextNode(t));
  }
}
...
s(n);
const l = async (t) => ({
  set: async (r, o) => (console.log(`--renderer [${r.data.curr.type}]`), {
    r: `

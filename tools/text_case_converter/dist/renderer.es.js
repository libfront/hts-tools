...
const g = async (t) => ({
  set: async (r, i) => {
    ...
    const e = [
      { name: "UPPERCASE", icon: "🔠", description: "ALL CAPITAL LETTERS" },
      { name: "lowercase", icon: "🔡", description: "all small letters" },
      { name: "Title Case", icon: "🏷️", description: "Each Word Capitalized" },
      { name: "camelCase", icon: "🐫", description: "firstWordCapitalized" },
      { name: "PascalCase", icon: "🔷", description: "EachWordCapitalized" },
      { name: "snake_case", icon: "🐍", description: "words_with_underscores" },
      { name: "kebab-case", icon: "🍢", description: "words-with-dashes" },
      { name: "Start Case", icon: "⭐", description: "First Letter Capital" },
      { name: "Sentence case", icon: "📝", description: "First word capitalized" }
    ];
    return {
      r: `

const g = async (e) => ({
  set: async (t, o) => {
    ...
    return {
      r: (() => {
        const r = t.data.curr.data.keys, a = t.data.curr.data.status || "idle", d = t.data.curr.data.error;
        return `
                            ...
                            <div class="max-w-4xl mx-auto">
                                ...
                                <div class="mb-8 text-center">
                                    <div id="${e.f.name("status")}" 
                                        class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${s(a)} bg-opacity-10 ${a === "success" ? "bg-green-500" : a === "error" ? "bg-red-500" : a === "generating" ? "bg-yellow-500" : "bg-gray-100"}"

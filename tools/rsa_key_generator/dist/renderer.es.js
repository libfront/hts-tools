...
const b = async (r) => ({
  set: async (e, l) => {
    ...
    return {
      r: (() => {
        const t = e.data.curr.data.keys, i = e.data.curr.data.status || "idle", n = e.data.curr.data.error;
        return `

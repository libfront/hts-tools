"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const e=async a=>({set:async(r,d)=>{console.log(`--renderer [${r.data.curr.type}]`);const s={value:()=>r.data.curr.data.data};return{r:`

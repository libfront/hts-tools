"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const s=async t=>({set:async(a,l)=>{console.log(`--renderer [${a.data.curr.type}]`);const e={value:()=>a.data.curr.data.data||"",theme:()=>a.data.curr.data.theme||"light"};return{r:`
          <div 
            id='${t.f.name("root")}' 
          ...
          * {
          ...
          `,r})()}}});exports.index=s;exports.renderer=s;

"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const s=async e=>({set:async(a,o)=>{console.log(`--renderer [${a.data.curr.type}]`);const t={value:()=>a.data.curr.data.data,theme:()=>a.data.curr.data.theme||"light"};return{r:(()=>{const r={light:"bg-white text-gray-900",dark:"bg-gray-900 text-white"};return`
